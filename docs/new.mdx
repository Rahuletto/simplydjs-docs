...
- DEPRECATED many functions. [Refer to docs](https://simplyd.js.org/docs/deprecated/renames.md)
...
- #### ChatGPT integration in chatbot
  * We have integrated ChatGPT (OpenAI API) into the chatbot function. Look its documentation for <a class="link" href="/docs/fun/chatbot.md">More info</a>

<br></br>

- #### Super Customizable embed
  * We added `fields`, `thumbnail`, `image` and literally everything that Discord.JS provides for embed. So you can customize even more. Making your bot, yours. Refer [`CustomizableEmbed`](/docs/typedef/CustomizableEmbed.md)
