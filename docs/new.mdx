...
- #### Super Customizable embed
  * We added `fields`, `thumbnail`, `image` and literally everything that Discord.JS provides for embed. So you can customize even more. Making your bot, yours. Refer [`CustomizableEmbed`](typedef/customizableembed.md)
