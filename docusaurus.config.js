...
module.exports = {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `<iframe src="https://github.com/sponsors/Rahuletto/button" title="Sponsor Rahuletto" height="32" width="114" style="border: 0; border-radius: 6px;"></iframe>
      <br><br><a href="https://www.netlify.com" target="_blank" rel="noreferrer noopener" aria-label="Deployed in Netlify"><img src="https://www.netlify.com/img/global/badges/netlify-color-accent.svg" alt="Deploys by Netlify" width="114" height="51" /></a>
